...
def calculate_cost():
    """Вычисляет стоимость рекламных материалов."""
    try:
...
# Кнопка "Рассчитать"
calculate_button = tk.Button(window, text="Рассчитать", command=calculate_cost, font=font)
calculate_button.grid(row=4, column=0, columnspan=2, pady=20) # Увеличенное pady
